class FriendRequestsController < ApplicationController
  ...
  def create
    ...
    if the_friend_request.valid?
      ...
      redirect_to("/friend_requests", { :alert => friend_request.errors.full_messages.to_sentence })
    end
  end
  ...
  def update
    ...
    if the_friend_request.valid?
      ...
      redirect_to("/friend_requests/#{the_friend_request.id}", { :alert => friend_request.errors.full_messages.to_sentence })
    end
  end
